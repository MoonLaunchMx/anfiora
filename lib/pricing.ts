...
export type WhatsappAgent = 'no' | 'addon' | 'included'
...
export interface AnfitrionPlan {
  ...
  bullets: string[]
  features: Feature[]
  whatsappAgent: WhatsappAgent // no = manual | addon = se compra | included = ya incluido (5000 msj)
}
...
export const ANFITRION_PLANS: AnfitrionPlan[] = [
  {
    ...
    bullets: [
      'Invitados, acompañantes + RSVP',
      'Mesas, timeline + presupuesto',
      'Proveedores + pagos',
      'Álbum (QR) + playlist',
    ],
    features: [],
