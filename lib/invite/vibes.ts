...
export const VIBES: Vibe[] = [
  ...
  v('disco', 'Disco', 'musica', { fondo: 'radial-gradient(circle at 50% 30%,#3a2a6a,#0a0620)', texto: '#f0d97a', acento: '#e0c04a', botonBg: 'linear-gradient(90deg,#ff2e97,#39ff88)', botonTexto: '#1a1030', titulo: 'monoton', forma: 'pill', estilo: 'degradado', fondoTipo: 'animado', efecto: 'bola-disco', si: 'bola-disco', no: 'luces-off' }),
