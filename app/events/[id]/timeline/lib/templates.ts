...
const BODA: TaskTemplate[] = [
  ...
  { title: 'Contratar fotografo y video',                  category: 'tarea',        offsetDays: 240, priority: 'no_bloqueante' },
  { title: 'Contratar musica / DJ o banda',                category: 'tarea',        offsetDays: 240, priority: 'no_bloqueante' },
  ...
  { title: 'Definir decoracion y flores',                  category: 'tarea',        offsetDays: 180, priority: 'no_bloqueante' },
  ...
  { title: 'Prueba de menu con el banquete',               category: 'reunion',      offsetDays:  60, priority: 'no_bloqueante' },
  ...
  { title: 'Confirmar logistica del dia con proveedores',  category: 'reunion',      offsetDays:   7, priority: 'bloqueante' },
...
const SOCIAL: TaskTemplate[] = [
  ...
  { title: 'Contratar musica / DJ',            category: 'tarea',        offsetDays:  90, priority: 'no_bloqueante' },
  { title: 'Decoracion y tematica',            category: 'tarea',        offsetDays:  75, priority: 'no_bloqueante' },
  ...
  { title: 'Confirmar logistica del dia',      category: 'reunion',      offsetDays:   3, priority: 'no_bloqueante' },
]
...
const CORPORATIVO: TaskTemplate[] = [
  ...
  { title: 'Contratar AV y produccion',                    category: 'tarea',        offsetDays:  90, priority: 'bloqueante' },
  ...
  { title: 'Material y branding (senaletica, gafetes)',    category: 'entrega',      offsetDays:  30, priority: 'no_bloqueante' },
  ...
  { title: 'Ensayo y logistica final',                     category: 'reunion',      offsetDays:   5, priority: 'bloqueante' },
]
