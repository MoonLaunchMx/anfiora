...
import { Music, Heart, X, Check } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
        <div className="flex max-h-[85vh] w-full max-w-md flex-col overflow-hidden rounded-t-2xl bg-white shadow-xl sm:rounded-2xl">

          <div className="flex shrink-0 items-start justify-between border-b border-[#f0f0f0] px-5 py-4">
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <Heart size={14} className="text-[#48C9B0]" fill="currentColor" />
                <h3 className="text-base font-bold text-[#1D1E20]">Agregar canción</h3>
              </div>
              <p className="mt-0.5 text-xs text-[#888]">Se marcará como canción de los novios.</p>
            </div>
            <button
              onClick={onClose}
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[#aaa] transition hover:bg-[#f5f5f5]"
            >
              <X size={16} />
            </button>
          </div>
          ...
          <div className="flex shrink-0 items-center justify-end border-t border-[#f0f0f0] bg-[#fafafa] px-5 py-3">
            <button
              onClick={onClose}
              className="rounded-lg bg-[#48C9B0] px-4 py-2 text-xs font-semibold text-white transition hover:bg-[#3aa896]"
            >
              Listo
            </button>
          </div>
