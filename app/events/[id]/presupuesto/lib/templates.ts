...
const BODA_ESENCIAL: BudgetItemTpl[] = [
  ...
  { category: 'Audio y Video', concepto: 'DJ o musica' },
  { category: 'Audio y Video', concepto: 'Fotografia' },
...
const BODA_CLASICA_EXTRA: BudgetItemTpl[] = [
  { category: 'Planeacion',    concepto: 'Coordinador del dia' },
  { category: 'Audio y Video', concepto: 'Video' },
  { category: 'Imagen',        concepto: 'Hair & makeup' },
  { category: 'Bebidas',       concepto: 'Coctel de bienvenida' },
  { category: 'Decoracion',    concepto: 'Iluminacion' },
...
const BODA_PREMIUM_EXTRA: BudgetItemTpl[] = [
  ...
  { category: 'Bebidas',       concepto: 'Barra premium / mixologia' },
  { category: 'Audio y Video', concepto: 'Cabina de fotos' },
  { category: 'Audio y Video', concepto: 'Dron / video aereo' },
  { category: 'Entretenimiento', concepto: 'Segundo show o DJ after' },
  { category: 'Decoracion',    concepto: 'Diseno floral premium' },
...
const SOCIAL: BudgetItemTpl[] = [
  ...
  { category: 'Audio y Video', concepto: 'DJ o musica' },
  { category: 'Audio y Video', concepto: 'Fotografia' },
  { category: 'Decoracion',    concepto: 'Decoracion y tematica' },
  { category: 'Papeleria',     concepto: 'Invitaciones' },
...
const CORPORATIVO: BudgetItemTpl[] = [
  { category: 'Planeacion',    concepto: 'Organizacion y coordinacion' },
  { category: 'Venue',         concepto: 'Sede' },
  { category: 'Banquete',      concepto: 'Catering / coffee break' },
  { category: 'Audio y Video', concepto: 'AV y produccion' },
  { category: 'Audio y Video', concepto: 'Fotografia y video' },
  { category: 'Decoracion',    concepto: 'Branding y ambientacion' },
