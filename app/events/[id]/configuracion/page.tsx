...
import { Copy, Check, UserPlus, X, Shield, Pencil, Eye, Settings2, Users, Gem, Crown, Cake, GraduationCap, Sun, PartyPopper, Wine, CalendarDays, Presentation, Monitor, UsersRound, Rocket, Building2, Tent, Mic, Flame, HeartHandshake, type LucideIcon } from 'lucide-react'
...
export default function ConfiguracionPage() {
  ...
  const loadEvent = async () => {
    const [{ data: eventData }, { data: collabData }] = await Promise.all([
    ...
    <div className="flex h-full flex-col overflow-hidden bg-white">
      ...
      <div className="shrink-0 border-b border-[#e8e8e8] bg-white px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-3 sm:hidden">
          <div className="grid grid-cols-2 gap-0.5 rounded-lg border border-[#e8e8e8] bg-[#f4f4f4] p-0.5">
            {TABS.map(tab => {
              const Icon = tab.icon
