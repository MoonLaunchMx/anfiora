...
export default function SegmentPage({ params }: { params: Promise<{ segment: string }> }) {
          ...
          <div className="grid items-center gap-8 md:grid-cols-[45%_55%]">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: 'easeOut' }}>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#c8f0e8] bg-[#f0fdf9] px-3 py-1.5">
                ...
                <span className="text-xs font-medium text-[#0F6E56]">{badge}</span>
              </div>
              <h1 className="mb-4 text-3xl font-bold leading-[1.2] tracking-tight text-[#1D1E20] md:text-4xl" style={{ fontFamily: 'Georgia, serif' }}>
                {title1}<br />
                <span className="text-[#48C9B0]">{title2}</span>
              </h1>
              <p className="mb-8 max-w-md text-base leading-relaxed text-[#666]">{sub}</p>
