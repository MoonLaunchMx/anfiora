...
**Mesas · escritorio (lista y plano).** Panel "Sin mesa" a la izquierda, agrupado por el Grupo que ya existe en la base (`guests.side`, la columna Grupo de Invitados; dentro del grupo cada titular con sus acompanantes debajo),
